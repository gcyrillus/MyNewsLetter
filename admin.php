<?php if(!defined('PLX_ROOT')) exit; 
	...
	if(!empty($_POST)) {	
		...
		if(isset($_POST['update'])) {
			...
			$plxPlugin->setParam('object',$_POST['object'], 'cdata');
		}
...
<p style="text-align:right;text-align:inline-end"><!--<a href="<?php echo PLX_ROOT ?>core/admin/"   title="<?php $plxPlugin->lang('L_BACK_TO_ADMINISTRATION') ?>"> <?php $plxPlugin->lang('L_BACK_TO_ADMINISTRATION') ?> </a> --> <a href="<?php echo PLX_ROOT ?>core/admin/parametres_plugin.php?p=MyNewsLetter"  title="<?php $plxPlugin->lang('L_GOTO_CONFIG') ?>"><?php $plxPlugin->lang('L_CONFIG') ?></a></p>
<div id="onglets">
