...
<div id="plxmnl">
	...
	<p><strong>Une version de PHP7 au minimum est requise pour son fonctionnement.</strong><span style="font-size: 8pt;"> (exit les h&eacute;bergements Free, m&ecirc;me &agrave; des fins de tests.)</span><strong><br></strong></p>
	...
	<p style="display: flex; justify-content: center; gap: 2em; max-width: 450px; margin: auto; background: #aed494;"><?php $plxPlugin->lang('L_SUBSCRIBE_OPTION') ?> <input type="checkbox"></p>
	...
	<?php if($plxPlugin->subscriptions) { echo '<p>Votre clé est: <b> '.$plxPlugin->subscriptions.'</b></p>';} else {echo '<p>Exemple de  clé: <b>  7692014e1c7fa0927b32deecf654e9df</b></p>';} ?>
