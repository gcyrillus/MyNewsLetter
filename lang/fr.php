<?php
    ...
    'L_OBJECT_TO_PRINT'         => 'Objet à afficher dans la boite mail',
    'L_SEND'                    => ' Envoyer',
    ...
    'L_MENTION'                 => 'Mention ',
    'L_MENTIONS'                => 'Mentions ',
    'L_SHOW_MENTION'            => 'Afficher les Mentions ',
    'L_MENTIONS_HTML'           => '<p style="text-align: center; margin: 0;">Vous recevez ce courriel car vous vous &ecirc;tes abonn&eacute; depuis&nbsp; ###DATE###. - ###STOP###</p>',
    'L_POS_MENTION'             => 'Position des mentions',
    'L_TOP'                     => 'Haut',
    'L_BOT_TITLE'               => 'Sous le titre',
    'L_BOTTOM'                  => 'Bas',
    'L_SHOW_FOOTER'             => 'Afficher le Pied ',
    'L_FOOTER'                  => 'Pied ',
    ...
    'L_NEWS_TITLE'              => 'Titre de la newsletter',
    'L_STATISTICS'              => 'Statistiques',
    'L_SUBSCRIBERS'             => 'Abonnés',
    'L_LAST_SEND'               => 'Date dernier envoi ',
    'L_NUMBER_OF_SUBSCRIBERS'   => 'Nombre d\'abonnement',
    'L_NUMBER_OF_UNSUBSCRIBERS' => 'Abonnements annulés',
    'L_VALIDATED_SUBSCRIBERS'   => 'Abonnements validés',
    'L_CLEANED_SUBSCRIBERS'     => 'Abonnements retirés',
    'L_NEWS_SENT'               => 'NewsLetter envoyées',
    'L_FEEDBACK'                => 'Retour aprés envois',
    'L_INFOS'                   => 'Infos',
    'L_CONFIG_INFOS'            => 'Infos de configuration',
    'L_MAIL_SENDER'             => 'Mail d\'envoi',
    'L_REGENERATE'              => 'Regenerer',
    'L_REGENERATE_FROM'         => 'Regenerer avec les articles depuis:',
    'L_CHOOSE_DURATION'         => 'Choisir une durée',
    'L_LOAD_ELSE_AND_REPLACE'   => '&Eacute;diter et remplacer par une précedente NewsLetter ',
    'L_LOAD_AND_REPLACE'        => 'Charger et remplacer',
    'L_VIEW_EDITING'            => 'Aperçu et édition',
    'L_EDITING'                 => 'Edition',
    'L_EDIT'                    => 'Editer',
    ...
    <p>Si vous ne recevez pas nos courriels, verifier que les newsLetter précédentes ne sont pas tombées dans vos spam/pourriels,<br> dans ce cas marquez cette adresse mail <b>%s</b>  comme légitime et ajoutez la à vos contacts pour pouvoir recevoir les Newsletter.</p>
    <p>Cordialement,<br> %s ,<br> Webmestre de  %s .</p>
    </div>',
    'L_UNSUBSCRIB'				=> ' &Agrave Bientôt,<br><br>Nous vous remercions d\'avoir été abonné à notre newsletter.<br>Nous espérons que nos contenus vous ont été utiles.<br>Cordialement,<br>',
    'L_SUBSCRIPTION_INFOS'      => '<div class="msg">
    <p> Inscrivez-vous à la newsletter de <b>%s</b> pour être informer des nouvelles publications.
    <br>Une notification ou un lien de validation sera envoyé sur l\'adresse mail que vous donnez.</p>
    <p><strong>Un lien de désabonnement est présent dans tous les courriels afin que vous puissiez révoquer votre abonnement d\'un simple clique.</strong></p>
    <p>Les données stockées correspondantes à votre abonnement sont :</p>
    <ul>
    <li>Votre adresse mail cryptée.</li>
    <li>La date d\'inscription</li>
    <li>La date du dernier envoi</li>
    </ul>
    <p><small>Les adresses mails cryptées ne sont utilisables que part le site les ayant cryptées et ne serviront, uniquement au NewsLetter. Elles ne seront ni transmises à un tiers ni utilisées à d\'autres usages.</small></p>
    </div>',
    'L_SUBSCRIPTION_PENDING'	=> '<div class="msg"><p>Bienvenue,</p>
    <p>Votre Abonnement <b>%s</b> est presque activé ...</p>
    <p>Un mail avec un lien de confirmation vous est envoyé pour finaliser votre inscription et nous autoriser à vous envoyer La newsletter du site.</p>
    <p>Si vous ne voyez pas ce premier mail, Vérifier que</p> 
    <ol>
    <li>L\'adresse utilisée :<b>%s</b> est bien la vôtre</li>
    <li>Que le courrier n\'est pas tombé dans vos spam/pourriels, dans ce cas marqué le comme légitime pour pouvoir recevoir les Newsletter</li>
    </ol>  
    <p>Les données stockées correspondantes à votre abonnement sont :</p>
    <ul>
    <li>Votre adresse mail cryptée.</li>
    <li>La date d\'inscription</li>
    <li>La date du dernier envoi</li>
    <li><a href="https://www.cnil.fr/fr/rgpd-de-quoi-parle-t-on" target="_blank">RGPD?</a></li>
    </ul>
    <p><a href="%s">Annuler cette demande</a>
    </div>',
    'L_SUBSCRIPTION_VALIDATE'   => '<div class="msg">
    <p>Bienvenue %s,</p>
    <p>Votre Abonnement <b>%s</b> est presque activé ...</p>
    <p><a href="%s">J\'active mon abonnement.(*)</a> - <a href="%s">J\'annule ma demande.</a>.</p>
    <p>Cordialement, <br> %s</p>
    <p><small>(*)  Votre adresse mail est cryptée. Elle est uniquement compatible et lisible par le script d\'envoi de NewsLetter de %s .<br> Elle est confidentielle et ne sera ni partagée ni utilisée à d\'autres usages.</small></p>
    </div>',
    'L_SUBSCRIPTION_VALIDATED'=>'<div class="msg">
    <p>Hello %s,</p>
    <p>Votre Abonnement est déjà actif.</p>
    <p>Veuillez vérifier que nos courriels ne sont pas tombés dans vos spam/pourriels, dans ce cas marquez les comme légitimes pour pouvoir recevoir les Newsletter.</p>
    <cite>%s</cite>
    </div>',
    'L_SUBSCRIPTION_AUTO'     => '<div class="msg">
    <p>Bienvenue %s,</p>
    <p>Votre Abonnement est actif(*) ...</p>
    <p>Vous pouvez l\'annuler à tous moment avec ce lien : <a href="%s">J\'annule ma demande</a>.</p>
    <p>Cordialement, <br> %s</p>
    <p><small>(*)  Votre adresse mail est cryptée. Elle est uniquement compatible et lisible par le script d\'envoi de NewsLetter de %s .<br> Elle est confidentielle et ne sera ni partagée ni utilisée à d\'autres usages.</small></p>
    </div>',
    'L_SUBSCRIPTION_ACTIVE'		=> '<div class="msg">
    <p>Bienvenue,</p>
    <p>Votre Abonnement <b>%s</b> est activé ...</p>
    <p>Un mail de confirmation vous a ete envoyé.</p>
    <p>Si vous ne voyez pas ce premier mail, Vérifier que</p> 
    <ol>
    <li>L\'adresse utilisée :<b>%s</b> est bien la vôtre</li>
    <li>Que le courrier n\'est pas tombé dans vos spam/pourriels, dans ce cas marqué le comme légitime pour pouvoir recevoir les Newsletter</li>
    ...
    <p>Un lien de désabonnement est présent dans chaque NewsLeter.</p>
    <p><a href="%s">Annuler cette demande</a>
    </div>',
    'L_STOP'					=> ' Me désabonner.',
    'L_CANCEL'					=> ' ANNULER.',
    
    #dates
    'L_MONTHLY'					=> ' Mensuel',
    'L_QUATERLY'				=> ' Trimestriel',
    'L_BI_ANNUAL'				=> ' Bi-annuel',
    'L_MONTH'                   => ' mois',
    'L_MONTH_OF'                => ' mois de ',
